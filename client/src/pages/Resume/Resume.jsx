...
// /* ──────────────────────────────────────────────────────
//    Resume Page — fits inside MainLayout as a child route
//    Path: /resume
//    ────────────────────────────────────────────────────── */
...
//   muted: "#8a8690",
//   accent: "#d4a24e",
//   accentDim: "rgba(212,162,78,0.12)",
...
//       }}
//     >
//       <span style={S.headingIcon}>{icon}</span>
//       <h2 style={S.headingText}>{text}</h2>
...
//         transition: `all .65s cubic-bezier(.22,1,.36,1) ${idx * 0.1}s`,
//       }}
//     >
//       <div style={S.tlDot} />
//       <div style={S.tlCard}>
//         <span style={S.tlDate}>{dates}</span>
//         <h3 style={S.tlRole}>{role}</h3>
//         <p style={S.tlCompany}>
//           <i className="fa-solid fa-building" style={{ marginRight: 6, color: C.accent, fontSize: 12 }} />
//           {company}
//         </p>
//         <ul style={S.tlBullets}>
//           {bullets.map((b, i) => (
//             <li key={i} style={S.tlBullet}>{b}</li>
//           ))}
//         </ul>
//       </div>
//     </div>
...
//       style={{
//         ...S.projCard,
//         borderColor: hover ? C.accent : C.border,
//         boxShadow: hover ? `0 8px 32px ${C.accentDim}` : "none",
//         transform: vis ? "translateY(0)" : "translateY(24px)",
//         opacity: vis ? 1 : 0,
//         transition: `all .5s cubic-bezier(.22,1,.36,1) ${idx * 0.08}s`,
//       }}
//     >
//       <span style={S.projType}>{type}</span>
//       <h3 style={S.projTitle}>{title}</h3>
//       <ul style={S.projBullets}>
//         {bullets.map((b, i) => (
//           <li key={i}>{b}</li>
//         ))}
//       </ul>
...
//         ...S.stat,
//         opacity: vis ? 1 : 0,
//         transform: vis ? "scale(1)" : "scale(.85)",
...
//     setTimeout(() => setPrintMode(false), 800);
//   };

//   // ─── Data ───
//   const skillCategories = {
//     Languages: ["JavaScript", "Java (Learning)", "SQL"],
//     Frontend: ["HTML5", "CSS3", "Bootstrap", "Tailwind CSS", "Responsive Design", "React.js"],
//     Backend: ["Node.js", "Express.js", "REST API Design"],
//     Databases: ["PostgreSQL", "MySQL", "MongoDB", "Sequelize ORM"],
//     Security: ["JWT", "OAuth 2.0", "bcrypt", "Email OTP", "Session Management"],
//     Tools: ["Git", "GitHub", "VS Code", "Postman"],
//   };

//   const skillBars = [
//     { label: "JavaScript / React", pct: 78 },
//     { label: "Node.js / Express", pct: 82 },
//     { label: "SQL & PostgreSQL", pct: 75 },
//     { label: "REST API Design", pct: 85 },
//     { label: "Security (JWT / OAuth)", pct: 80 },
//     { label: "Git & Workflow", pct: 72 },
//   ];
...
//       bullets: [
//         "Engineered a secure authentication system using JWT and OAuth 2.0, reducing unauthorized access risk and strengthening application-wide security posture",
//         "Implemented Email OTP verification and bcrypt password hashing, safeguarding credentials for 100% of registered users",
//         "Built and optimized session management workflows, improving login persistence and reducing repeat authentication friction",
//         "Delivered full-stack features end-to-end in collaboration with senior developers within an Agile development environment",
//       ],
//     },
//     {
//       company: "SkillEcted",
...
//       bullets: [
//         "Developed 10+ responsive, cross-browser web pages using HTML5, CSS3, and JavaScript, improving usability across devices",
//         "Designed and executed CRUD operations on MySQL databases, ensuring efficient data storage, retrieval, and integrity",
//         "Collaborated with a 5-member development team using Git/GitHub for version control and code reviews, reducing merge conflicts",
//         "Performed systematic testing and debugging, improving overall code quality and reducing production defects",
//       ],
//     },
//   ];
...
//       bullets: [
//         "Built a role-based access control system supporting 3 user roles (admin, faculty, student) using Node.js, Express.js, and PostgreSQL",
//         "Designed normalized database schemas with Sequelize ORM and exposed secure RESTful APIs for CRUD operations",
//       ],
//     },
//     {
...
//       bullets: [
//         "Designed and developed a fully responsive personal portfolio with SEO optimization, improving search visibility and recruiter discoverability",
//       ],
//     },
//     {
//       title: "E-Commerce Clones & API Integration",
//       type: "Amazon, Myntra, To-Do App",
//       bullets: [
//         "Replicated core e-commerce features (product listings, cart, responsive UI) using React.js and modern CSS frameworks across 2 platform clones",
//         "Built a full-featured To-Do application and integrated multiple third-party REST APIs for real-time data handling",
//       ],
//     },
//   ];
...
//   const achievements = [
//     "Successfully delivered 6+ full-stack and frontend projects spanning authentication systems, e-commerce platforms, and productivity tools",
//     "Implemented industry-standard security practices (JWT, OAuth 2.0, bcrypt, OTP) across internship projects; maintained an active GitHub portfolio with consistent contributions",
//   ];
...
//             <i className="fa-solid fa-file-lines" style={{ color: C.accent }} />
//             <span style={S.topBarTitle}>My Resume</span>
//           </div>
...
//           <h1 style={S.heroName}>
//             Omkar Nilkanth <span style={{ color: C.accent }}>Jadhav</span>
//           </h1>
...
//             <a href="https://linkedin.com/in/omkar-jadhav-6915052a1" target="_blank" rel="noopener noreferrer" style={S.heroLinkBtn}>
//               <i className="fa-brands fa-linkedin-in" /> LinkedIn
//             </a>
//             <a href="https://github.com/Omkar200583" target="_blank" rel="noopener noreferrer" style={S.heroLinkBtn}>
...
//         <Stat num={6} suffix="+" label="Projects Delivered" />
//         <Stat num={2} suffix="" label="Internships" />
//         <Stat num={10} suffix="+" label="Web Pages Built" />
//         <Stat num={100} suffix="%" label="Users Secured" />
//       </div>

//       {/* ── Summary ── */}
//       <section style={S.section}>
//         <Heading icon={<i className="fa-solid fa-user-tie" />} text="Professional Summary" />
//         <div style={S.summaryCard}>
//           <p style={S.summaryText}>
//             Results-driven Computer Science undergraduate and Full Stack Developer with hands-on experience building secure, scalable web
//             applications using the MERN stack and PostgreSQL/MySQL. Delivered authentication systems (JWT, OAuth 2.0, Email OTP, bcrypt), RESTful
//             APIs, and responsive UIs across two internships, completing 6+ full-stack and frontend projects. Strong fundamentals in data structures,
//             algorithms, and software engineering best practices, with a consistent record of writing clean, secure, and maintainable code.
//           </p>
//           <div style={S.summaryHL}>
//             <i className="fa-solid fa-bullseye" style={{ color: C.accent, fontSize: 16, marginRight: 10, marginTop: 2 }} />
//             <span>Seeking <strong>Full Stack Developer</strong>, <strong>Software Developer</strong>, or <strong>Backend Developer</strong> roles to deliver measurable business impact.</span>
//           </div>
//         </div>
//       </section>
...
//       {/* ── Skills ── */}
//       <section style={S.section}>
//         <Heading icon={<i className="fa-solid fa-layer-group" />} text="Technical Skills" />
//         <div style={S.skillsGrid}>
//           <div style={S.skillTagsCol}>
//             {Object.entries(skillCategories).map(([cat, items]) => (
//               <div key={cat} style={S.skillCat}>
//                 <h4 style={S.skillCatTitle}>{cat}</h4>
//                 <div style={S.skillTagWrap}>
//                   {items.map((s) => (
...
//             ))}
//           </div>
//           <div style={S.skillBarsCol}>
//             {skillBars.map((s, i) => {
//               const [ref, vis] = useReveal();
//               return (
//                 <div key={s.label} ref={ref}>
//                   <SkillBar label={s.label} pct={s.pct} delay={i * 100} visible={vis} />
//                 </div>
//               );
//             })}
//           </div>
...
//       {/* ── Experience ── */}
//       <section style={S.section}>
//         <Heading icon={<i className="fa-solid fa-briefcase" />} text="Internship Experience" />
//         <div style={S.tlContainer}>
//           <div style={S.tlLine} />
//           {experience.map((exp, i) => (
//             <TimelineItem key={exp.company} {...exp} idx={i} />
//           ))}
//         </div>
//       </section>
...
//       {/* ── Projects ── */}
//       <section style={S.section}>
//         <Heading icon={<i className="fa-solid fa-diagram-project" />} text="Projects" />
//         <div style={S.projGrid}>
//           {projects.map((p, i) => (
//             <ProjectCard key={p.title} {...p} idx={i} />
//           ))}
//         </div>
//       </section>
...
//       {/* ── Education ── */}
//       <section style={S.section}>
//         <Heading icon={<i className="fa-solid fa-graduation-cap" />} text="Education" />
//         <div style={S.eduCard}>
//           <div style={S.eduIcon}>
//             <i className="fa-solid fa-university" />
//           </div>
//           <div>
//             <h3 style={S.eduDegree}>B.Sc. Computer Science</h3>
//             <p style={S.eduSchool}>Savitribai Phule Pune University</p>
//           </div>
//         </div>
//       </section>
...
//         <div style={S.twoCol}>
//           <div>
//             <Heading icon={<i className="fa-solid fa-certificate" />} text="Certifications" />
//             <div style={S.itemList}>
//               {certs.map((c) => (
//                 <div key={c} style={S.itemCard}>
//                   <i className="fa-solid fa-award" style={{ color: C.accent, marginRight: 10, marginTop: 2 }} />
//                   <span>{c}</span>
//                 </div>
//               ))}
//             </div>
//           </div>
//           <div>
//             <Heading icon={<i className="fa-solid fa-trophy" />} text="Achievements" />
//             <div style={S.itemList}>
//               {achievements.map((a) => (
//                 <div key={a} style={S.itemCard}>
//                   <i className="fa-solid fa-star" style={{ color: C.accent, marginRight: 10, marginTop: 2 }} />
//                   <span>{a}</span>
//                 </div>
//               ))}
//             </div>
...
//       {/* Injected CSS for keyframes, hover, responsive, print */}
...
//     margin: "0 0 12px",
//     letterSpacing: "-0.5px",
//     animation: "rFadeUp .7s ease both",
//   },
//   heroTitle: {
...
//     letterSpacing: "2px",
//     margin: "0 0 28px",
//     animation: "rFadeUp .7s ease .1s both",
//   },
//   heroMeta: {
//     display: "flex",
//     flexWrap: "wrap",
...
//     color: C.muted,
//     marginBottom: 28,
//     animation: "rFadeUp .7s ease .2s both",
//   },
//   heroLinks: {
//     display: "flex",
//     justifyContent: "center",
//     gap: 12,
//     animation: "rFadeUp .7s ease .3s both",
//   },
//   heroLinkBtn: {
//     display: "inline-flex",
//     alignItems: "center",
...
//   skillFill: {
//     height: "100%",
//     background: `linear-gradient(90deg, ${C.accent}, #e8c56d)`,
//     borderRadius: 4,
//   },
//   skillPct: {
//     width: 36,
...
// /* ═══════════════════════════════════════════════════════════
//    INJECTED CSS — keyframes, hover, responsive, print
//    ═══════════════════════════════════════════════════════════ */
// const injectedCSS = `
//   @keyframes rFadeUp {
...
//   /* Hover states */
//   a:hover { color: #d4a24e !important; }
//   .projCard:hover { transform: translateY(-3px) !important; }
//   .heroLinkBtn:hover { border-color: #d4a24e !important; color: #d4a24e !important; }
//   .skillTag:hover { background: rgba(212,162,78,0.12) !important; border-color: rgba(212,162,78,0.3) !important; color: #d4a24e !important; }
//   .printBtn:hover { background: rgba(212,162,78,0.22) !important; }
//   li::marker { color: #d4a24e; }
...
//     .summaryCard, .tlCard, .projCard, .eduCard, .itemCard {
...
//     .statNum { color: #b8862d !important; }
//     .skillFill { background: #b8862d !important; }
//     .tlDot { background: #b8862d !important; border-color: #fff !important; }
...
//     a { color: #b8862d !important; text-decoration: underline !important; }
